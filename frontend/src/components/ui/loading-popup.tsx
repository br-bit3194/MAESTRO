...
export const LoadingPopup: React.FC<LoaderProps> = ({ size = 180, text = "Generating", show }) => {
  if (!show) return null;
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      ...
      >
        {letters.map((letter, index) => (
          <span
            key={index}
            className="inline-block text-white dark:text-white opacity-40 animate-loaderLetter"
